...
class Maze:
  ...
  This class outlines the structure of the maze problem
   ...
   def getSuccessors(self, state):
        ...
        #print(self.three_actions,"after rotation as per heading ",self.theta)    
        ...
        for action in self.three_actions:
            ...
            if self.isObstacle(new_successor,action):
               ...
               print(action,"went into obstacle")
               continue
# =============================================================================
...
# =============================================================================
            ...
            #print()
        #print(successors,"these are succesors going")
...
# =============================================================================
   ...
   def getGoalState(self,robot_id):
         ...
         if robot_id==1:
             None
             #goal_state = [4,22,0]#self.maze_map.r1_goal
         elif robot_id==2:
   ...
   #      """
         if abs(state[0] - 4) + abs(state[1] - 22) < 1.8 : #self.getGoalState(robot_id):
             return True
         else:
             return False    

...
print("im in matsya mmg ")

def matsya_ode(t, v, delta_c, wind_flag=0, wind_speed=0, wind_dir=0,
    ...
    psi = v[5]
    delta = v[6]
    #n_prop = v[7]  # why Propulsion commented ?
    ...
    T_rud = 0.001  # Corresponds to a time constant of 0.1 * L / U_des = 2 seconds

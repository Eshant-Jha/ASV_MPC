      ...
      if planner==1:
          ...
          if scenario.isGoalState(current_node[0],reference_path): 
              ...
              #steps = 15   
                ...
                # Plot the path
                # x_coords=  [point[0] for point in explored]
                # y_coords = [point[1] for point in explored]
                ...
                # plt.grid(True)
                # plt.show()
                print("total cost found is ",current_node[2],current_node[3])
                return [path_coordinates,explored,fringe_cd]
